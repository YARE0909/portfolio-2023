...
const TEXTS = ["UI/UX", "Websites", "Anything", "Webapps"];
...
export default function Home() {
  ...
  return (
    <div className="w-full min-h-screen h-fit flex flex-col">
      ...
      }} className="flex-1 p-6 flex items-start mt-24 lg:mt-56 justify-start lg:pl-64 bg-cover bg-no-repeat">
        <div>
          <div>
          ...
          <div className="flex flex-col lg:flex lg:flex-row lg:gap-2 items-start">
            <h1 className="text-3xl font-bold text-gray-500">I design and develop</h1>
